...
@section('content')
    ...
    <div class="col-12 col-lg-6 col-xl-4 border-top-wide border-primary d-flex flex-column justify-content-center">
        <div class="container container-tight my-5 px-lg-5">
            ...
            <form action="{{ route('admin.login') }}" method="post" autocomplete="off" novalidate="">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="email" class="form-control"
                        placeholder="{{ __('app.login.email_placeholder') }}" value="admin@gov.local" autocomplete="off">
                    @error('email')
                ...
                <div class="mb-2">
                    ...
                    <div class="input-group input-group-flat">
                        <input type="password" name="password" class="form-control"
                            placeholder="{{ __('app.login.password_placeholder') }}" value="Admin@168" autocomplete="off">
            ...
            <div class="text-center text-secondary mt-3">{{ __('app.login.login_as') }}
                <a href="/" tabindex="-1">{{ __('app.login.user') }}</a>
            </div>
        </div>
    </div>
    <div class="col-12 col-lg-6 col-xl-8 d-none d-lg-block">
        ...
        <div class="bg-cover h-100 min-vh-100"
            style="background-image: url({{ asset('img/backgrounds/boy-with-rocket-light.png') }})">
        </div>
    </div>
