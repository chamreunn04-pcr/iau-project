    ...
    <div class="container-fluid">
        ...
        <div class="navbar-brand navbar-brand-autodark">
            <a href="." aria-label="Tabler">
                <img src="{{ asset('favicon.ico') }}" alt="IAU Logo" class="navbar-image" style="max-height: 2rem;">
            </a>
        </div>
        <!-- END NAVBAR LOGO -->
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            ...
            <ul class="navbar-nav pt-lg-3">
                <li class="nav-item {{ active_class('admin.dashboard', 'active') }}">
                    <a class="nav-link {{ active_class('admin.dashboard', 'active') }}"
                        href="{{ route('admin.dashboard') }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <x-icon name="home" class="icon icon-1" />
                        </span>
                        <span class="nav-link-title"> {{ __('app.sidebar.dashboard') }} </span>
                    </a>
                </li>
                <li
                    class="nav-item dropdown {{ active_class(['admin.users', 'admin.user_permissions', 'admin.user_permissions.edit'], 'active') }}">
                    <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown"
                        data-bs-auto-close="false" role="button" aria-expanded="false">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <x-icon name="users" class="icon icon-1" />
                        </span>
                        <span class="nav-link-title"> {{ __('app.sidebar.manage_users') }} </span>
                    </a>
                    <div
                        class="dropdown-menu {{ active_class(['admin.users', 'admin.user_permissions', 'admin.user_permissions.edit'], 'show') }}">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item" href="./alerts.html"> {{ __('app.sidebar.create_user') }}
                                </a>
                                <a class="dropdown-item {{ active_class('admin.users', 'active') }}"
                                    href="{{ route('admin.users') }}"> {{ __('app.sidebar.users') }} </a>
                                <a class="dropdown-item {{ active_class(['admin.user_permissions', 'admin.user_permissions.edit'], 'active') }}"
                                    href="{{ route('admin.user_permissions') }}">
                                    {{ __('app.sidebar.user_permissions') }} </a>
                            </div>
                        </div>
                    </div>
                </li>
                <li
                    class="nav-item dropdown {{ active_class(['admin.roles', 'admin.permissions', 'admin.roles'], 'active') }}">
                    <a class="nav-link dropdown-toggle" href="#navbar-form" data-bs-toggle="dropdown"
                        data-bs-auto-close="false" role="button" aria-expanded="false">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <x-icon name="shield-cog" class="icon icon-1" />
                        </span>
                        <span class="nav-link-title"> {{ __('app.sidebar.role_and_permissions') }} </span>
                    </a>
                    <div
                        class="dropdown-menu {{ active_class(['admin.roles', 'admin.permissions', 'admin.roles'], 'show') }}">
                        <a class="dropdown-item {{ active_class('admin.roles', 'active') }}"
                            href="{{ route('admin.roles') }}"> {{ __('app.sidebar.roles') }} </a>
                        <a class="dropdown-item {{ active_class('admin.permissions', 'active') }}"
